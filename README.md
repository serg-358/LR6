...
В ходе выполнения данной лабораторной работы я изучил базовые возможности системы управления версиями, получил опыт работы с Git Api, с локальным и 
удалённым репозиторием, а также освоил новые команды для работы с ветками, файлами, фиксациями изменений и их публикации.
